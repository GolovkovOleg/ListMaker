...
class MainActivity : AppCompatActivity(), ListSelectionFragment.OnFragmentInteractionListener {
    ...
    private var listFragmet: ListDetailFragment? = null
    ...
    private fun showListDetail(list: TaskList) {
        if (!largeScreen) {
            ...
            title = list.name
            listFragmet = ListDetailFragment.newInstance(list)
            supportFragmentManager.beginTransaction()
                .replace(R.id.fragment_container, listFragmet!!, getString(R.string.list_fragment_tag))
                .addToBackStack(null)
                .commit()
